...
${OBJECTDIR}/bgp.o: bgp.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/bgp.o bgp.cpp

${OBJECTDIR}/bgp_attrib_alias.o: bgp_attrib_alias.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/bgp_attrib_alias.o bgp_attrib_alias.cpp

${OBJECTDIR}/bgp_database.o: bgp_database.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/bgp_database.o bgp_database.cpp

${OBJECTDIR}/bgp_main.o: bgp_main.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/bgp_main.o bgp_main.cpp

${OBJECTDIR}/bgp_notification.o: bgp_notification.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/bgp_notification.o bgp_notification.cpp

${OBJECTDIR}/bgp_open.o: bgp_open.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/bgp_open.o bgp_open.cpp

${OBJECTDIR}/bgp_peer.o: bgp_peer.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/bgp_peer.o bgp_peer.cpp

${OBJECTDIR}/bgp_send.o: bgp_send.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/bgp_send.o bgp_send.cpp

${OBJECTDIR}/bgp_syslog.o: bgp_syslog.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/bgp_syslog.o bgp_syslog.cpp

${OBJECTDIR}/bgp_thread-mgr.o: bgp_thread-mgr.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/bgp_thread-mgr.o bgp_thread-mgr.cpp

${OBJECTDIR}/bgp_timer.o: bgp_timer.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/bgp_timer.o bgp_timer.cpp

${OBJECTDIR}/bgp_update.o: bgp_update.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/bgp_update.o bgp_update.cpp
...
${OBJECTDIR}/tcp_server.o: tcp_server.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/tcp_server.o tcp_server.cpp
