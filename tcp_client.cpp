...
void tcp_client::disconnect(void) {
    ...
    // no. will reuse socket.
    //tcp_socket = 0;
}

/** Resize tx stream buffer size.
 *
...
/** Resize rx stream and rx tcp socket buffers
 */
...
/** Resize tx stream and tx tcp socket buffers
 */
